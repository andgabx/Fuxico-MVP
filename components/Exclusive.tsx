...
import { ExclusiveMobile } from "./ExclusiveMobile";
...
export function Exclusive() {
    return (
        <>
            ...
            {/* Desktop Version */}
            <section className="hidden md:block relative w-full overflow-hidden py-[8vh] bg-cream-1">
                {/* Background Banner */}
                            ...
                            <div className="flex-1 order-2 lg:order-1 max-w-2xl mx-auto lg:mx-0 w-full">
                                ...
                                <div className="rounded-2xl sm:rounded-3xl bg-cream-2 p-4 sm:p-6 lg:p-8 shadow-lg">
                                    <p className="mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg leading-relaxed text-brown-1 text-left">
                                        Mergulhe no universo criativo recifense
                                        com nossas <strong>blindboxes</strong>{" "}
                                        exclusivas. Cada envio traz em uma
                                        surpresa diferente um novo jeito de
                                        fazer arte, desenhada para revelar o
                                        estilo e a história de um artista local
                                        em cada detalhe.
                                    </p>
